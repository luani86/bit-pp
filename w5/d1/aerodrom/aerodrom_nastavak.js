...
(function () {
    ...
    function Airport() {
        ...
        this.getData = function () {
            var airportData = "Airport: " + this.name;
            var numberOfPassengers = function () {
                var sum = 0;
                for (var i = 0; i < this.listOfFlights.length; i++) {
                    sum = sum + this.listOfFlights[i].listOfPassengers.length;
                }
            }
            ...
            //     flight.date.getDate() + "," + (flight.date.getMonth() + 1) + "," + flight.date.getFullYear() + flight.relation + "\n" +
            //     seat.getData() + " " + passenger.getData() + "\n";
        }
    }
    ...
    var passenger4 = createPassenger("Miloje", "Milojevic", 5);
